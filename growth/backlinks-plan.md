...
> ⚠️ 第一铁律：**只做高质量外链，绝不碰外链农场。** 1 条媒体上稿 > 100 条垃圾目录。
> 为什么 + 怎么分辨，见下方「质量 vs 农场」教学段。
...
## 0. 先搞懂：什么是「高质量外链」，什么是「外链农场」（必读）

**高质量外链（我们要的）= 编辑性 · 相关性 · 权威性**
- 媒体客座文（Trade Arabia / Gulf News 等投的稿，文内自然带我们链接）
- 行业 roundup / 专家引言被记者引用
- 权威商业目录的**真实公司档案**（Crunchbase、LinkedIn 公司页、Clutch、Bayt）—— 这类叫"引用 / citation"，Google 和 AI 都认，是"你这家公司真实存在"的信号
- 真实社区回答（Reddit / Quora）被读、被赞、被引
- 特征：**每个链接都"相关 + 权威 + 自然"**，一年内自然增长，不追求数量

**外链农场（千万别碰）= 批量 · 低质 · 不相关**
- 自动批量提交到上千个低质量目录站
- PBN（私有博客网络）、链接买卖群、评论区群发
- 付费堆链接、"1000 条外链 $5"
- 为什么有害：Google 的垃圾链接算法（Penguin）+ AI 引擎都会**识别并惩罚 / 忽略**；一旦被标"不自然链接"，排名反而掉，且清理极难。GEO 也绝不引用农场链接。

**我们的铁律**：宁可在 30 天里只有 3 条真链接，也不要 300 条农场链接。质量 > 数量，永远。

## 0.5 自动化的边界（重要，别被"自动外链"骗了）

- ✅ **能自动化**：可见度监控（每周跑搜索看我们 / 竞品在哪）、外链机会发现（每周搜可 pitch 媒体）、内容准备（客座文 / pitch / 回答模板我都写好）
- ❌ **不能自动化**：真正"获取"外链的动作（联络编辑、发社区回答、登录建公司页）是关系 / 人工动作——但我会把内容备好，你只复制粘贴 / 点发送
- 已为你建好的自动化：① 每周引用率监控（验证 sourcetogulf 是否进 AI / 搜索答案）② 热词雷达（每周选题）③ 每日 GSC 词循环 ④ **外链机会发现（每周，见下）**。这些每周自动跑、产出文件在 `growth/`。
...
> ⚠️ 品牌规则：对外只叫 **SourceToGulf**。"广州东达东供应链管理有限公司" 只是营业执照上的法律名，
