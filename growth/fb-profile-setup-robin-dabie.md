# FB 双号资料填写（Robin / dabie）

三条铁律：① Name 栏填真名，别塞公司名/关键词（会锁号）；② 地址写 **Guangzhou, China**，不写迪拜；③ 两个号所有内容都不一样，否则双双降权。
...
**Name**：`Robin Gu`
**Bio**：`China sourcing agent. Car accessories, camping gear, gadgets → Dubai. Low MOQ, samples OK.`
**Work**：`Sourcing Manager` at `SourceToGulf`
...
**置顶帖**：
```
Hi 👋 I'm Robin, based in Guangzhou, China.
I help Gulf sellers find products from Chinese factories — car accessories, camping & outdoor gear, gadgets.
• Find the factory, not a markup middleman
• Low MOQ — start small
...
## dabie 号（女品：abaya / 首饰 / 美妆工具）

**Name**：`Dabie [你的姓]`
**Bio**：`Helping Gulf women build small shops with China-sourced abayas, jewelry & beauty. From 20 pcs.`
**Work**：`Product Sourcing` at `SourceToGulf`
...
```
🌸 Hey, I'm Dabie — and if you've ever wanted a little shop of your own but didn't know where to start, you're exactly who I'm here for.

I'm based in Guangzhou, right by the markets, and every week I pick out pieces Gulf women actually love to wear and sell: abayas & modest wear, homewear, fashion jewelry, hijabs, bags, beauty tools.

How we do it together:
→ start with just 20–50 pieces, no warehouse commitment
→ I send a sample so you feel the fabric before you buy
→ your name & packaging on it, if you want
→ I check every piece at the market before it ships
...
1. 两个号**错开时间**填完资料 + 发置顶帖
2. **养号 3–5 天**：加中东好友、进买卖群、评论点赞，**不发商品**
3. 第 4–6 天起发商品帖（另出）
