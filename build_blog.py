...
'<section class="sec"><div class="wrap">'
'<div class="sec-head"><h2>SABER 2026 fees and the cosmetics ingredient ban</h2></div>'
'<p>Two 2026 changes catch small buyers by surprise because they sit outside the headline announcements. First, the certificate fees: the Product Conformity (PC) certificate costs about <b>575 SAR</b> and the Shipment Certificate (SC) about <b>402.5 SAR</b> per filing — a flat fee each time, not a percentage of order value, so a tiny trial batch pays proportionally more. Second, from 1 January 2026 Saudi banned <b>21 cosmetic ingredients</b> (including certain UV filters and preservatives) in products sold in the Kingdom; formulations must be reformulated or they will not clear. If you import skincare or cosmetics, check the ingredient list against the SFDA banned list before booking SABER, not after the goods are made.</p>'
'<p>The practical takeaway: budget the PC + SC fees into every Saudi shipment, and treat the cosmetics ingredient check as a pre-production step. An agent who pre-checks both keeps a batch from being stuck at Jeddah.</p>'
'</div></section>'
'<section class="sec alt"><div class="wrap">'
...
'</ul>'
'<section class="sec"><div class="wrap">'
'<div class="sec-head"><h2>Skincare &amp; beauty private label: the OEM compliance path</h2></div>'
'<p>Beauty is the fastest-growing TikTok Shop category in Saudi and the UAE, and the winning angle is not reselling a generic serum — it is a private-label line made to Gulf compliance. A China OEM/ODM factory can produce under <b>GMPC</b> and <b>ISO 22716</b> cosmetics GMP, apply your logo and bilingual Arabic/English label, and ship low-MOQ batches of a few hundred units. Two compliance steps matter before launch: register the product with <b>SFDA</b> (Saudi) or <b>MOHAP</b> (UAE), and confirm the formula is free of the 21 cosmetic ingredients Saudi banned from 1 January 2026. TikTok Shop Saudi also ran a <b>90-day commission waiver</b> for new beauty sellers, which lowers the cost of testing a first line.</p>'
'<p>The composite path fits here precisely: we shortlist a compliant OEM, send you filled samples, lock the Arabic label, pre-book SABER/SFDA, and air-ship the batch — so your TikTok listing goes live with a product you have held, not one you guessed at from a photo.</p>'
'</div></section>'
'<div class="rel-grid">'
...
# ===========================================================================
# 文章 5: 如何从中国的私牌 skincare 打到沙特 / 阿联酋（小品牌 2026 How-to）
# 热词来源: 美妆私牌中东爆发（TikTok Shop 沙特/阿联酋）、竞品 maxcare 用 haircare OEM 长文占坑
# 角度: 大站写 "What is private label"；我们写 "How to 小品牌用中国 OEM + 复合能力合规落地 GCC"
# 钉住买家人设: small brands / influencers / side-hustle moms（美妆私牌）
# ===========================================================================
SKINCARE_FAQ = [
...
def skincare_body():
    wa = wa_link('Hi SourceToGulf! I want to launch a private-label skincare line for Saudi/UAE. Can you find a compliant China OEM, send me samples, handle the Arabic label + SFDA/SABER, and ship a low-MOQ batch?')
    return (
'<section class="sec hero-sec"><div class="wrap">'
...
'<section class="sec"><div class="wrap">'
'<div class="sec-head"><h2>Why skincare private label from China is a Gulf small-brand opening</h2></div>'
'<p>The Gulf is one of the fastest-growing beauty markets per capita, and two shifts made it reachable for small brands. First, social commerce — TikTok Shop, Instagram and Snapchat — lets a creator or small shop sell directly without a retail buyer. Second, China OEM/ODM factories now offer low-MOQ private label with real GMP, so you can launch a branded serum or cream without tooling a factory. The gap most small brands hit is not demand; it is the compliance and sourcing step between "I have an idea" and "a compliant box is at my door in Riyadh or Dubai."</p>'
'</div></section>'

'<section class="sec alt"><div class="wrap">'
'<div class="sec-head"><h2>The four things you do not need</h2></div>'
'<ul class="bullets">'
'<li><b>A factory in the Gulf.</b> A China OEM produces the formula to GMPC / ISO 22716; you own the brand and the customer relationship.</li>'
'<li><b>A container.</b> A first line is usually 100 to 500 units per SKU, air-shipped. A container is for proven, high-volume products.</li>'
'<li><b>A chemistry degree.</b> The OEM supplies formulation and stability testing; your job is the brief, the label and the market.</li>'
'<li><b>Big upfront capital.</b> Most private-label launches land under $4,000 for product, samples, packaging, compliance and first air shipment.</li>'
'</ul>'
'</div></section>'

'<section class="sec"><div class="wrap">'
'<div class="sec-head"><h2>The step-by-step path from idea to a box at your door</h2></div>'
'<ol class="bullets">'
'<li><b>Pick a category and claim.</b> Serums, creams, cleansers and masks all private-label well. Choose one you can show on video and that is not a regulated drug claim.</li>'
'<li><b>We shortlist compliant OEMs.</b> Two or three China factories with GMPC / ISO 22716, low MOQ, and export experience to the Gulf.</li>'
'<li><b>Samples to your door.</b> We ship filled samples to your UAE or Saudi address so you approve the texture and smell on camera.</li>'
'<li><b>Lock the private-label packaging.</b> Your logo on the box, bilingual Arabic/English label, MOQ 100 to 500 units typical.</li>'
'<li><b>Pre-book compliance.</b> SFDA + SABER (Saudi) or MOHAP + ECAS (UAE); confirm the formula is free of the 21 banned Saudi ingredients.</li>'
'<li><b>Air-ship the batch.</b> A few hundred units arrive in 5 to 8 days; list and sell while the line is fresh.</li>'
'</ol>'
'</div></section>'

'<section class="sec alt"><div class="wrap">'
'<div class="sec-head"><h2>Saudi vs UAE compliance at a glance</h2></div>'
'<table class="tbl" style="width:100%;border-collapse:collapse;margin:18px 0;font-size:15px">'
'<thead><tr style="background:#0b1f3a;color:#fff"><th style="padding:10px 12px;text-align:left">Step</th><th style="padding:10px 12px;text-align:left">Saudi Arabia</th><th style="padding:10px 12px;text-align:left">United Arab Emirates</th></tr></thead>'
'<tbody>'
'<tr style="border-bottom:1px solid #e6e9ef"><td style="padding:10px 12px"><b>Product registration</b></td><td style="padding:10px 12px">SFDA</td><td style="padding:10px 12px">MOHAP</td></tr>'
'<tr style="border-bottom:1px solid #e6e9ef;background:#f7f9fc"><td style="padding:10px 12px"><b>Conformity certificate</b></td><td style="padding:10px 12px">SABER PC + SC</td><td style="padding:10px 12px">ECAS</td></tr>'
'<tr style="border-bottom:1px solid #e6e9ef"><td style="padding:10px 12px"><b>Labels</b></td><td style="padding:10px 12px">Arabic required</td><td style="padding:10px 12px">Arabic + English</td></tr>'
'<tr style="border-bottom:1px solid #e6e9ef;background:#f7f9fc"><td style="padding:10px 12px"><b>Ingredient rule</b></td><td style="padding:10px 12px">21 substances banned from 1 Jan 2026</td><td style="padding:10px 12px">MOHAP positive list</td></tr>'
'<tr style="border-bottom:1px solid #e6e9ef"><td style="padding:10px 12px"><b>Duty (HS 33)</b></td><td style="padding:10px 12px">5% (China-GCC FTA can cut it)</td><td style="padding:10px 12px">5% (China-GCC FTA can cut it)</td></tr>'
'<tr style="border-bottom:1px solid #e6e9ef;background:#f7f9fc"><td style="padding:10px 12px"><b>VAT</b></td><td style="padding:10px 12px">15%</td><td style="padding:10px 12px">5%</td></tr>'
'</tbody></table>'
'<p>The two systems are separate. A SFDA registration does not clear goods in Dubai, and an ECAS certificate does not clear goods in Jeddah. A multi-country launch needs the right track per destination — which is why most small brands start with one country and add the second once the first line sells.</p>'
'</div></section>'

'<section class="sec"><div class="wrap">'
'<div class="sec-head"><h2>Worked example: a $3,500 private-label serum line to Dubai</h2></div>'
'<table class="tbl" style="width:100%;border-collapse:collapse;margin:18px 0;font-size:15px">'
'<thead><tr style="background:#0b1f3a;color:#fff"><th style="padding:10px 12px;text-align:left">Step</th><th style="padding:10px 12px;text-align:left">Action</th><th style="padding:10px 12px;text-align:left">Cost</th></tr></thead>'
'<tbody>'
'<tr style="border-bottom:1px solid #e6e9ef"><td style="padding:10px 12px">1</td><td style="padding:10px 12px">3 OEM serum samples shipped to Dubai</td><td style="padding:10px 12px">$90</td></tr>'
'<tr style="border-bottom:1px solid #e6e9ef;background:#f7f9fc"><td style="padding:10px 12px">2</td><td style="padding:10px 12px">Approve 1 formula; design label box (MOQ 300)</td><td style="padding:10px 12px">$320</td></tr>'
'<tr style="border-bottom:1px solid #e6e9ef"><td style="padding:10px 12px">3</td><td style="padding:10px 12px">MOHAP + ECAS for HS 33 cosmetics</td><td style="padding:10px 12px">$560</td></tr>'
'<tr style="border-bottom:1px solid #e6e9ef;background:#f7f9fc"><td style="padding:10px 12px">4</td><td style="padding:10px 12px">300 units, branded, air-shipped to UAE</td><td style="padding:10px 12px">$2,530</td></tr>'
'</tbody></table>'
'<p>Total landed cost: about <b>$3,500</b> for 300 branded, compliant units delivered to your door. Sell at a 3x landed price and the batch grosses about $10,500. The same line at Gulf-local manufacturing MOQ would tie up several times the capital before a single unit sold.</p>'
'</div></section>'

'<section class="sec alt"><div class="wrap">'
'<div class="sec-head"><h2>How to choose a China skincare OEM without getting burned</h2></div>'
'<p>The factory, not the logo, decides whether your line clears. Three checks before you commit:</p>'
'<ul class="bullets">'
'<li><b>GMP certificates.</b> Ask for GMPC and ISO 22716 (cosmetics GMP). A factory without them is a liability for Gulf compliance.</li>'
'<li><b>Export record to the GCC.</b> Factories that have shipped to Saudi or UAE before already know Arabic labels and SFDA/MOHAP paperwork.</li>'
'<li><b>MOQ and formulation flexibility.</b> Confirm the private-label MOQ (100 to 500 is normal) and whether they can adjust a formula to drop a banned ingredient.</li>'
'</ul>'
'<p>We shortlist against these three, ship you filled samples first, and only place the bulk order against the exact sample you approved. You never buy a formula you have not held.</p>'
'</div></section>'

'<section class="sec"><div class="wrap">'
'<div class="sec-head"><h2>Mistakes that sink a skincare launch</h2></div>'
'<ul class="bullets">'
'<li>Skipping SFDA/MOHAP — TikTok Shop and Amazon do not exempt you from Gulf cosmetics law, and clearance cannot be fixed after arrival.</li>'
'<li>Ignoring the 21-ingredient ban — a formula with a banned substance is stopped at the Saudi border after you have paid for production.</li>'
'<li>Ordering before samples — you cannot vouch for a texture or smell you have not held.</li>'
'<li>Generic reselling — a white-label product with no brand competes on price with every other reseller.</li>'
'<li>Starting compliance after production — the registration buffer is what keeps the launch date honest.</li>'
'</ul>'
'<div class="rel-grid">'
'<a class="rel-card" href="/blog/saber-2026-saudi-buyers-playbook.html"><span>SABER 2026 playbook</span><b>Compliance timeline for Saudi goods</b></a>'
'<a class="rel-card" href="/blog/china-gcc-fta-lower-import-duty.html"><span>China-GCC FTA</span><b>Cut duty on HS 33 cosmetics</b></a>'
'<a class="rel-card" href="/blog/source-products-tiktok-shop-saudi-no-container.html"><span>TikTok Shop Saudi</span><b>Beauty is the top category</b></a>'
'<a class="rel-card" href="/services/custom-branding-packaging.html"><span>Custom packaging</span><b>Arabic labels + your logo</b></a>'
'<a class="rel-card" href="/for-small-businesses.html"><span>For small brands</span><b>Launch a private-label line</b></a>'
'<a class="rel-card" href="/category-beauty-toys.html"><span>Beauty &amp; toys</span><b>HS 33 — on the FTA list</b></a>'
'</div>'
'</div></section>'
...
BLOG = {
    ...
    'gcc-fta-2026': {
        ...
        'desc': 'How small Gulf buyers actually claim the China\u2013GCC FTA tariff cut: 1,420 HS codes reduced by ~7.4 points, the Certificate of Origin requirement, and a step-by-step checklist from a China sourcing team.',
        'date': '2026-08-24',
    ...
    'tiktok-saudi-2026': {
        ...
        'desc': 'How Gulf influencers and small sellers source TikTok Shop products from China without a container: low MOQ, samples to you, private-label packaging, SABER compliance, and air options, from a China sourcing team.',
        'date': '2026-08-24',
    ...
    'white-friday-2026': {
        ...
        'desc': 'A practical guide for Gulf small sellers sourcing White Friday 2026 stock from China: timeline, best products, samples, private-label packaging, all-in cost example, and compliance — from a China sourcing team.',
        'date': '2026-08-26',
    ...
    'skincare-private-label-2026': {
        ...
        'desc': 'How small Gulf brands private-label skincare from China to Saudi and UAE: GMPC/ISO 22716 OEMs, low-MOQ samples, Arabic labels, SFDA/SABER and MOHAP/ECAS compliance, and an all-in cost example — from a China sourcing team.',
        'date': '2026-08-27',
    ...
    'gulf-trends-2026': {
        ...
        'desc': 'Data-backed 2026 Gulf sourcing trends mapped to real products: 18K PVD sand-gold jewelry, moissanite, LED beauty devices and modest fashion — MOQs, FOB prices and compliance from a China sourcing team.',
        'date': '2026-08-27',
    ...
    'delivery-journey': {
        ...
        'desc': 'The exact path we run for every Gulf order - real sample, private-label packaging, samples to you, factory stock-up and compliant container loading - mapped to sand-gold, moissanite, beauty devices and modest fashion, with real MOQs.',
        'date': '2026-08-27',
